...
///////////////////////////////////////////////////////////////////
            if(localStorage.getItem('neutral') == 'active'){
                ...
                if(startingFlavor2.value == ''){
                    startingFlavor2.value = 'Love'
                    startingFlavor12.innerHTML = 'Love'
            ...
            if(localStorage.getItem('neutral') == 'not active' && localStorage.getItem('randomPriority') == 'not active' && localStorage.getItem('previousPriority') == 'not active'){
        ...
        function submit(){
            ...
            pf2.innerHTML = sflav
            pf3.innerHTML = tflav
            console.log(pf1,pf2,pf3,'these are the previous flavors in teh submitttttttttttttttttttttttttttttttttttttttttttttttttttttttttt')
